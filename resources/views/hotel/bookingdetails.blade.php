                                ...
                                <div class="row">
                                    <div class="col-lg-5 mb-3">
                                        ...
                                        <div class="border rounded-sm border-gray-400">
                                            <div class="p-3">
                                                <div class="flex-container bg-blue-50 bookingdetails-flex-container-__wrapper p-3">
                                                    <div class="flex-item">
                                                        <p>Check-in</p>
                                                ...
                                                <div class="text-center pb-3">
                                                    <form method="GET" action="/hotels/{{$hotel->id}}/{{$dates_frominput}}#rooms-availability">
                                    ...
                                    <div class="col-lg-7">
                                        ...
                                        <form method="POST" action="{{route('book.transactiondetails')}}">
                                            @csrf
                                            @method('PUT')
                                                            ...
                                                            <li class="flex justify-between mb-2">
                                                                <div class="pb-5 mb-5">
                                                                    ...
                                                                    <select class="custom-select" required name="payment_method">
                                                                        <option selected hidden value="">Choose payment method</option>
                                            ...
                                            <div class="mt-5">
                                                <div class="flex justify-end">
                                                    <x-button class="bg-green-800 font-bold text-sm hover:bg-green-700 active:bg-green-900 focus:border-green-900 ring-green-300 py-3py-3" onclick="return confirm('Complete booking?')">Complete Booking</x-button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
